            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">سلة محذوفات الترتر</h2>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                     <a href="{{ route('tarter.index') }}" class="btn btn-primary pull-right"> <i class="feather icon-arrow-right"></i>  العودة للطلبات</a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-action">
                                        <span class="action-restore btn btn-success btn-sm" onclick="restoreTarter({{ $Record->id }})" title="استرجاع"><i class="feather icon-rotate-ccw"></i></span>
                                        <span class="action-force-delete btn btn-danger btn-sm" onclick="forceDeleteTarter({{ $Record->id }})" title="حذف نهائي"><i class="feather icon-trash-2"></i></span>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
