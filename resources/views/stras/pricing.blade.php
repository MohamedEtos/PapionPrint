        ...
        <div class="content-header row">
             <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">إعدادات أسعار الاستراس</h2>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">اسعار مقاسات الاستراس</h4>
                        </div>
                ...
                <div class="col-md-4">
                     <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">تكاليف التشغيل</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <table class="table table-bordered">
             ...
             function updatePrice(input) {
                 ...
                 $.ajax({
                     ...
                     success: function(response) {
                         ...
                         setTimeout(function() {
                             // input.removeClass('is-valid'); // Keep the checkmark
